...
# from apps.groups.serializers import BranchModelSerializer, RoomCreateModelSerializer, GroupModelSerializer
...
#         return Group.objects.create(name='Role 1')
#
#     def test_group_model_serializer(self, group_fixture):
